<x-app-layout>
    <x-slot name="title">Applicant Form Options</x-slot>

    <x-slot name="url_1">{"link": "/moderator/dashboard", "text": "Moderator"}</x-slot>
    <x-slot name="active">Applicant Profile Options</x-slot>
    ...
    <x-modern-header chip="Applicant Profile Options" title="Manage Dropdown Options"
        desc='Manage the dropdown options that appear in the Applicant Profile form.'>
    </x-modern-header>
