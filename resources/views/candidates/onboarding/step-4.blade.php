    ...
    <div class="onboard-card">
        ...
        <div class="review-section">
            <h3>
                ...
                <a href="{{ route('candidate.onboarding.show', ['step' => 1]) }}" class="edit-link"><i
        ...
        <div class="review-section">
            <h3>
                ...
                <a href="{{ route('candidate.onboarding.show', ['step' => 2]) }}" class="edit-link"><i
                        class="ri-pencil-line"></i> Edit</a>
            </h3>
            @php
        ...
        <div class="review-section">
            <h3>
                ...
                <a href="{{ route('candidate.onboarding.show', ['step' => 3]) }}" class="edit-link"><i
                        class="ri-pencil-line"></i> Edit</a>
            </h3>
            <div class="review-row">
                <span class="label">Years of Experience</span>
                <span class="value">{{ $profile->years_experience ?? '—' }}
                    {{ $profile->years_experience ? 'years' : '' }}</span>
            </div>
            <div class="review-row">
        ...
        {{-- Launch action --}}
        <form method="POST" action="{{ route('candidate.onboarding.store', ['step' => 4]) }}">
            @csrf
            <div class="onboard-actions" style="border-top:none;margin-top:20px;padding-top:0;">
                <a href="{{ route('candidate.onboarding.show', ['step' => 3]) }}" class="btn-back">
                    <i class="ri-arrow-left-line"></i> Back
                </a>
                <button type="submit" class="btn-next btn-launch">
