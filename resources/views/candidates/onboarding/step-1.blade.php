...
@section('step-content')
    ...
    <style>
        ...
        .address-summary strong { color: #334155; font-weight: 700; }
        ...
        .address-builder__field { margin-bottom: 0 !important; }
        ...
        .address-builder .hint { margin-top: 0; font-size: 11px; line-height: 1.45; }
        ...
        @media (max-width: 560px) { .address-builder__grid { grid-template-columns: 1fr; } }
    </style>
    ...
    <div class="onboard-card">
        ...
        <form method="POST" action="{{ route('candidate.onboarding.store', ['step' => 1]) }}">
            @csrf
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="job_title" value="{{ old('job_title', $profile->job_title ?? $profile->title) }}" required list="applicant_title_list" placeholder="Select or type your job title">
                    <datalist id="applicant_title_list">
                    ...
                    <div class="hint"><i class="ri-user-line"></i> Choose from the list or type a specific job title</div>
                </div>
            </div>
            ...
            <div class="onboard-actions">
                <div></div>
                <button type="submit" class="btn-next">Continue <i class="ri-arrow-right-line"></i></button>
            </div>
        </form>
    </div>
    ...
    <script>
        (function () {
            ...
            if (!locationInput || !countryEl || !phSection || !manualSection || !manualAddressInput || !regionEl || !provinceEl || !cityEl || !barangayEl || !statusEl || !form) return;
