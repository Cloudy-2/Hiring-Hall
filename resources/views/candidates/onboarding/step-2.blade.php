...
@section('step-content')
    <div class="onboard-card">
        ...
        <form method="POST" action="{{ route('candidate.onboarding.store', ['step' => 2]) }}">
            @csrf

            {{-- Expertise Categories (Specializations) --}}
            <div class="section-divider"><i class="ri-focus-3-line"></i> Specializations</div>
            <div class="form-group">
                <div class="hint" style="margin-bottom:10px;"><i class="ri-add-circle-line"></i> Type each specialization and click "Add" to add more</div>
                @php
                    $specializations = old('specializations', $profile->specializations ? json_decode($profile->specializations, true) : []);
            ...
            <div class="onboard-actions">
                <a href="{{ route('candidate.onboarding.show', ['step' => 1]) }}" class="btn-back">
