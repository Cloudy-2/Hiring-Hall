<x-app-layout>
    ...
    <x-slot name="active">Create Relationship</x-slot>
                    ...
                    <div class="box-body">
                        ...
                        <div class="grid grid-cols-12 sm:gap-x-6 gap-y-3">
                            ...
                            <div class="xl:col-span-12 col-span-12">
                                ...
                                <div class="relative">
                                    <textarea name="notes" id="notes" class="ti-form-input rounded-sm ps-11 focus:z-10"
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (previewBtn) {
                previewBtn.addEventListener('click', function () {
                    // Populate modal fields from form data
                    const getValue = (name) => {
                        const el = form.querySelector(`[name="${name}"]`);
                        return el ? el.value || '-' : '-';
                    };

                    document.getElementById('preview-company_name').textContent = getValue('company_name');
                    document.getElementById('preview-type').textContent = getValue('type');
                    document.getElementById('preview-lead_source').textContent = getValue('lead_source');
                    document.getElementById('preview-phone').textContent = getValue('phone');
                    document.getElementById('preview-email').textContent = getValue('email');
                    document.getElementById('preview-fax').textContent = getValue('fax');
                    document.getElementById('preview-website').textContent = getValue('website');
                    document.getElementById('preview-license').textContent = getValue('license');
                    document.getElementById('preview-insurance').textContent = getValue('insurance');
                    ...
                    // Use Preline's overlay method if available, otherwise fallback
                    if (window.HSOverlay) {
                        ...
                        // You might need more logic here if Preline isn't handling it
                    }
                });
            }
        });
