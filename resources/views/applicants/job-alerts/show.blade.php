<x-app-layout>
    ...
    <x-slot name="title">Alert Results</x-slot>
                ...
                <div class="box-body">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('applicant.job-alerts.edit', $alert) }}" class="ti-btn ti-btn-outline-primary ti-btn-sm">
                                <i class="ri-edit-line me-1"></i> Edit Alert
                            </a>
                            <a href="{{ route('applicant.job-alerts.index') }}" class="ti-btn ti-btn-outline-light ti-btn-sm">
                                Back
                            </a>
                        </div>
                    </div>
