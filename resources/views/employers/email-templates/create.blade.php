<x-app-layout>
    ...
    <x-slot name="pageTitle">Create Email Template</x-slot>
    ...
    <div class="grid grid-cols-12 gap-x-5 gap-y-4">
        ...
        <div class="col-span-12">
            <div class="cd-page-hero">
                <div>
                    <h1 class="cd-page-hero-title"><i class="ri-mail-add-line me-2"></i>Create Email Template</h1>
                    <p class="cd-page-hero-sub">Create reusable email templates with merge fields</p>
                </div>
        ...
        <div class="col-span-12 lg:col-span-8">
            <div class="cd-section">
                <form method="POST" action="{{ route('employer.email-templates.store') }}">
                    @csrf
                    ...
                    <div class="grid grid-cols-12 gap-4 mb-6">
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="e.g., Interview Invitation" required>
                        </div>
                        <div class="col-span-12 md:col-span-6">
                            <label class="form-label">Template Type <span class="text-danger">*</span></label>
                            <select name="type" class="form-select" required>
                                @foreach($types as $value => $label)
                                    <option value="{{ $value }}" @selected(old('type', 'custom') == $value)>{{ $label }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-4 mb-6">
                        <div class="col-span-12">
                            ...
                            <input type="text" name="subject" class="form-control" value="{{ old('subject') }}" placeholder="e.g., Interview Invitation for {job_title} at {company_name}" required>
                    ...
                    <div class="grid grid-cols-12 gap-4 mb-6">
                        <div class="col-span-12">
                            ...
                            <textarea name="body" class="form-control font-mono text-sm" rows="12" placeholder="Dear {applicant_name},
...
Best regards,
{employer_name}" required>{{ old('body') }}</textarea>
                        </div>
                    </div>
